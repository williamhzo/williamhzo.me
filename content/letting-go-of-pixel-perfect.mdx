...
<small>
  _Building for everyone also means shipping experiences that are great
...
<small>
  _Their input is therefore limited, and crucial aspects of the design will have
  ...
  that's also a whole other topic, I plan to write about it soon._
</small>
